...
import { processMultipleRefs } from '../utils/processMultipleRefs'
...
export const TextArea = React.forwardRef<HTMLTextAreaElement, HtmlTextAreaProps>((props, ref) => {
  const { register } = useFormCtx()
  return <textarea {...props} ref={processMultipleRefs(register, ref)} />
})
